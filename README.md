...
![界面概览](docs/screenshots/01-overview.png)
### 文档入库
支持拖拽或点击上传，解析完成后提示「入库成功」，文档内容即写入 Milvus 指定集合。
![文档入库](docs/screenshots/02-upload-success.png)
### 智能问答
基于向量检索召回相关片段，由大模型生成结构化回答，内容紧扣已上传的知识库。
![智能问答](docs/screenshots/03-qa-answer.png)
### 参考依据溯源
每条回答下方可展开「参考依据」，查看检索到的原文片段及相似度分数，便于核对答案来源。
![参考依据溯源](docs/screenshots/04-qa-sources.png)
